...
import { UPCOMING_FEES } from "@/constants/data/upcoming_fees";
...
export default function UpcomingFeesPage() {
  const data = UPCOMING_FEES.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Upcoming Fees</h1>
      </div>
