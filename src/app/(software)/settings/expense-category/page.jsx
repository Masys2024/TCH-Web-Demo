...
import AddVoucherCategoryForm from "@/components/sections/settings/voucher-category/add-voucher-category-form";

export default function VoucherCategoryPage() {
  const data = CATEGORIES.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Voucher Category</h1>
        <AddVoucherCategoryForm formData={formData} setFormData={setFormData} />
      </div>
