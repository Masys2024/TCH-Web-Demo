...
import { EMERGENCY_CIRCULAR } from "@/constants/data/emergency-circular";

export default function EmergencyCircularPage() {
  const data = EMERGENCY_CIRCULAR.map((circular, idx) => ({
    srNo: idx + 1,
    ...circular,
  }));
    ...
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">
          View/Update Emergency Circular
        </h1>
        <Link href={INTERNAL_LINKS.ADD_EMERGENCY_CIRCULARS}>
          <Button>
