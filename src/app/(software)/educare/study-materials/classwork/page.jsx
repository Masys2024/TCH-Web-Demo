...
import { CLASSWORKS } from "@/constants/data/classworks";

export default function ClassworkPage() {
  const data = CLASSWORKS.map((classwork, idx) => ({
    srNo: idx + 1,
    ...classwork,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Update Classwork Schedule</h1>
        <Link href={INTERNAL_LINKS.ADD_CLASSWORK}>
          <Button>
