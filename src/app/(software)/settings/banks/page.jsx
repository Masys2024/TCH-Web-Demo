...
import { BANKS } from "@/constants/data/banks";
import AddBankForm from "@/components/sections/settings/banks/add-bank-form";

export default function BanksPage() {
  const data = BANKS.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        ...
        <AddBankForm formData={formData} setFormData={setFormData} />
      </div>
