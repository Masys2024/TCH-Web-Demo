...
import AddCourseDialog from "@/components/sections/settings/courses/add-course-dialog";

export default function CoursesPage() {
  const data = COURSES.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  const columns = [
    ...
    {
      accessorKey: "Course_Fees",
      header: "Course Fees",
    },
    {
      accessorKey: "Book_Fees",
      header: "Book Fees",
    },
    {
      accessorKey: "actions",
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        ...
        <AddCourseDialog formData={formData} setFormData={setFormData} />
      </div>
