...
import AddBoardForm from "@/components/sections/settings/boards/add-board-form";

export default function BoardPage() {
  const data = BOARDS.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        ...
        <AddBoardForm formData={formData} setFormData={setFormData} />
      </div>
