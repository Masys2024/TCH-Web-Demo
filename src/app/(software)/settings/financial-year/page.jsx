...
import AddFinancialYearForm from "@/components/sections/settings/financial-years/add-financial-year-form";

export default function FinancialYearsPage() {
  const data = ACADEMIC_YEARS.map((item, idx) => ({
    srNo: idx + 1,
    ...item,
  }));
  ...
  return (
    <section className="p-6 max-w-7xl mx-auto">
      <div className="w-full pb-8 flex items-center justify-between">
        ...
        <AddFinancialYearForm formData={formData} setFormData={setFormData} />
      </div>
